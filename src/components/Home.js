...
        setOrganizationInfo({ name: "เกิดข้อผิดพลาด", logo: logo });
        // --- (จุดที่ 5: อนุญาตให้แสดงผล... เพื่อโชว์ Error) ---
        setIsLoading(false);
...
  };
  ...
  // --- (จุดที่ 6: เพิ่มส่วนนี้ทั้งหมด) ---
  if (isLoading) {
    // ถ้ายังตรวจสอบไม่เสร็จ ให้แสดงหน้าโหลดค้างไว้
    return (
      <div style={{ 
          display: 'flex', 
...
  // ถ้า isLoading เป็น false แล้ว (ตรวจสอบเสร็จแล้ว) ค่อยแสดงผลหน้านี้
  return (
    <div>
