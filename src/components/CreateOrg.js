  ...
  useEffect(() => {
    const fetchTypes = async () => {
      ...
      try {
        ...
        const orgTypePromise = fetch('https://premium-citydata-api-ab.vercel.app/api/organization-types');
        const usageTypePromise = fetch('https://premium-citydata-api-ab.vercel.app/api/usage-types');
